...
public class FollowerConstants {
    ...
    private static double xMovement = 68.2194;
    private static double yMovement = 49.9912;
    ...
    public static double mass = 11.33981; // 25 lbs
    ...
    public static double forwardZeroPowerAcceleration = -30.2758;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -74.4661;
