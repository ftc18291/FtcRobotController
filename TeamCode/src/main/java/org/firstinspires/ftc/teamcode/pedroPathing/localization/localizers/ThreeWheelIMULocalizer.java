...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = .001989436789;//  0.002957;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = .001989436789;//  -0.003127403096038503;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = .001989436789;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-4.125, 3.5, 0);
        rightEncoderPose = new Pose(4.125, -3.5, 0);
        strafeEncoderPose = new Pose(-0.5, 0, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontLeftMotor"));
