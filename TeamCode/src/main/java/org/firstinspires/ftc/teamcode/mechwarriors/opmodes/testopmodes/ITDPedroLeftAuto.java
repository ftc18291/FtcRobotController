...
@Disabled
@Autonomous(name = "Example Left Auto", group = "Examples")
public class ITDPedroLeftAuto extends OpMode {
     ...
     */
    private final Pose startPose = new Pose(9, 81, Math.toRadians(90));

    /**
     * Scoring Pose of our robot. It is facing the nets at a 135 degree angle.
     */
